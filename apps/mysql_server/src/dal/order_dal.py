...
class OrderDAL:
    ...
    def insert_order_items(self, order_id, items: dict):
            ...
            for item in items:
                insert_query = """
                               ...
                               VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,
                                       %s, %s, %s, %s, %s, %s, %s, %s, %s) ON DUPLICATE KEY
                               UPDATE
                                   fulfillment_status=
                               VALUES (fulfillment_status), shipped_quantity=
                               VALUES (shipped_quantity), tracking_number=
                               VALUES (tracking_number), carrier=
                               VALUES (carrier), shipped_at=
                               VALUES (shipped_at), delivered_at=
                               VALUES (delivered_at) \
                               """
                value = (order_id,
                         item['item_id'],
                ...
                connection.commit()
                logger.info(f"Inserted/Updated {len(items)} items for order ID {order_id}")
        except Exception as e:
            connection.rollback()
