    ...
    def upsert_product(self, product_id, supplier_id, supplier_name,
        ...
        try:
            upsert_query = """
                           ...
                           VALUES (short_description), category=
                           VALUES (category), unit_type=
                           VALUES (unit_type), base_sku=
                           VALUES (base_sku), brand=
                           VALUES (brand), base_price_cents=
                           VALUES (base_price_cents), status=
                           VALUES (status), view_count=
                           VALUES (view_count), favorite_count=
                           VALUES (favorite_count), purchase_count=
                           VALUES (purchase_count), total_reviews=
                           VALUES (total_reviews), published_at=
